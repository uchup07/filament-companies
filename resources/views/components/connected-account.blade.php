...
@php
    $providerEnum = \Uchup07\FilamentCompanies\Enums\Provider::tryFrom($provider);
@endphp
                ...
                <div class="filament-companies-connected-account-info font-semibold">
                    ...
                    @if (!empty($createdAt))
                        <div
                            ...
                            {{ __('filament-companies::companies.labels.connected') }}
                            <div
                    ...
                    @else
                        <div class="filament-companies-connected-account-not-connected text-xs text-gray-400">
                            {{ __('filament-companies::companies.labels.not_connected') }}
                        </div>
                    @endif
                </div>
            </div>

...
class UpdateProfileInformationForm extends Component
{
    ...
    {
        Notification::make()
            ->title(__('filament-companies::companies.notifications.profile_information_updated.title'))
            ->success()
            ->body(__('filament-companies::companies.notifications.profile_information_updated.body'))
            ->send();
    }
    ...
    public function sendEmailVerification(): void
    {
        ...
        Notification::make()
            ->title(__('filament-companies::companies.notifications.verification_link_sent.title'))
            ->success()
            ->body(__('filament-companies::companies.notifications.verification_link_sent.body'))
            ->send();
    }

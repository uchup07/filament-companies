...
//use Uchup07\FilamentCompanies\Actions\UpdateCompanyEmployeeRole;
...
use Uchup07\FilamentCompanies\Role;
...
class CompanyEmployeeManager extends Component
{
    ...
    {
        Notification::make()
            ->title(__('filament-companies::companies.notifications.company_invitation_sent.title'))
            ->success()
            ->body(Str::inlineMarkdown(__('filament-companies::companies.notifications.company_invitation_sent.body', compact('email'))))
            ->send();
    }
}

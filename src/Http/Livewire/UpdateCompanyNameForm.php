...
class UpdateCompanyNameForm extends Component
{
    ...
    protected function companyNameUpdated($company): void
    {
        ...
        Notification::make()
            ->title(__('filament-companies::companies.notifications.company_name_updated.title'))
            ->success()
            ->body(Str::inlineMarkdown(__('filament-companies::companies.notifications.company_name_updated.body', compact('name'))))
            ->send();
    }
